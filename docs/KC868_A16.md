...
The KC868-A16 exposes four analog inputs (INA1, INA2, INA3, INA4). The board
routes INA1 and INA4 through the 4-20 mA front-end and INA2 and INA3 through the
0-5 V front-end. The firmware samples these on ADC1 with 12-bit resolution and
11 dB attenuation, reporting raw counts (0-4095).

| Signal | Type | GPIO | ADC Channel |
| --- | --- | --- | --- |
| INA1 | 4-20 mA | GPIO36 | ADC1_CH0 |
| INA4 | 4-20 mA | GPIO39 | ADC1_CH3 |
| INA2 | 0-5 V | GPIO34 | ADC1_CH6 |
| INA3 | 0-5 V | GPIO35 | ADC1_CH7 |
...
| 2 | 2 | Analog INA1 raw (little-endian) |
| 4 | 2 | Analog INA4 raw (little-endian) |
| 6 | 2 | Analog INA2 raw (little-endian) |
| 8 | 2 | Analog INA3 raw (little-endian) |
